...
Pilot::Pilot(ros::NodeHandle & n) {
	...
	moveService = n.advertiseService("move", &Pilot::move, this);
...
void Pilot::processVel(const geometry_msgs::Twist & vel) {
...
void Pilot::sendVels(int id1, int vel1, int dir1, int id2, int vel2, int dir2) {
	...
	unsigned char pkt[] = { 0xFF, 0xFF, 0xFE, 0x0A, 0x83, 0x20, 0x02, id1,
			vel1low, vel1hi, id2, vel2low, vel2hi, 0x00 };
...
PLUGINLIB_EXPORT_CLASS(PilotNodelet, nodelet::Nodelet);
